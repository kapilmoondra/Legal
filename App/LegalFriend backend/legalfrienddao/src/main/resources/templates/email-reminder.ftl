            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px 50px 50px 50px"><p style="color:#262626; font-size:24px; text-align:left; font-family: HelVetica, Geneva, sans-serif"><strong>Dear ${userName}</strong>,</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: HelVetica, Geneva, sans-serif; line-height:22px ">Greetings of the day! <br /><br />
Here is the agenda for the day <br /> 
							<#list dateList as value>
    							 <li style="color:#000000; font-size:16px; font-family: HelVetica, Geneva, sans-serif"">${value?date}</li>
    							 		<#list caseList as case>
    							 			<#assign dateValue = case.nextHearingDate?date>
    							 			<#if value?date == dateValue>
												 	<p style="color:#000000; font-size:16px; text-indent: 50px; font-family: HelVetica, Geneva, sans-serif"">CaseID: ${case.caseId}</p><br/>
											</#if>
										</#list>
										<br/>
										<br/>
