            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                                            ...
                                            <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:left;font-size:0;" ><!--[if (gte mso 9)|(IE)]>
                                              ...
                                              <div class="column" style="width:100%;max-width:80px;display:inline-block;vertical-align:top;">
                                                <table class="contents" style="border-spacing:0; width:100%"  >
                                                  <tr>
                                                    <td style="padding-top:5px;padding-bottom:0;padding-right:0;padding-left:5px;" align="center"><a href="#" target="_blank"><img src="http://13.127.27.1/images/logo.png" alt="" width="60" height="60" style="border-width:0; max-width:60	px;height:auto; display:block" align="center"/></a></td>
                                                  </tr>
                                                </table>
                                              </div>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px 50px 50px 50px"><p style="color:#262626; font-size:24px; text-align:left; font-family: HelVetica, Geneva, sans-serif"><strong>Dear ${user_name}</strong>,</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: HelVetica, Geneva, sans-serif; line-height:22px ">Welcome and Thank you for joining India's best Legal Case Managment Software, LegalFriend. <br /><br />
To get started, verify your account by clicking on the link below<br />
                        <br />
                        <br />
                      </p>
                        ...
                        <tbody>
                          <tr>
                            <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                <tr>
                                  <td width="250" height="60" align="center" bgcolor="#ff7e65" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="${verificationUrl}" style="width:300; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Helvetica, Arial, sans-serif; color: #ffffff" class="button_link">Verify your EMail</a></td>
                                </tr>
                              </table></td>
                          </tr>
                        </tbody>
                      </table>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: HelVetica, Geneva, sans-serif; line-height:22px "><br />
                        <br />
                        <br />
                        <br />
                        <br />
                        Best Regards, <br />
                        Team LegalFriend</p></td>
                  </tr>
                </table>
                  ...
                  <tr>
                    <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;"><!--[if (gte mso 9)|(IE)]>
                      ...
                      <div class="column" style="width:100%;max-width:350px;display:inline-block;vertical-align:top;">
                        <table class="contents" style="border-spacing:0; width:100%">
                          <tr>
                            <td width="61%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><p style="color:#787777; font-size:13px; text-align:left; font-family: HelVetica, Geneva, sans-serif"> All Rights Reserved &copy; 2018, LegalFriend.com<br />
                          </tr>
                        </table>
                      </div>
